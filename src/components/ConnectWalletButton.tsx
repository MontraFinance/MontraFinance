            ...
            <div className="absolute right-0 top-full mt-2 w-56 bg-card border border-border rounded-xl shadow-xl z-50 overflow-hidden">
              ...
              <div className="p-1.5">
                ...
                <button
                  ...
                  className="w-full flex items-center gap-2 text-xs font-mono px-3 py-2 rounded-lg hover:bg-destructive/10 transition text-muted-foreground hover:text-destructive"
                >
                  <LogOut size={12} />
                  Disconnect
                </button>
